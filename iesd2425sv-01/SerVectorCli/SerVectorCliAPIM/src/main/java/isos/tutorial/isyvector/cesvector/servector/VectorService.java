 ...
 * 
 */
@WebServiceClient(name = "VectorService", targetNamespace = "http://servector.cesvector.isyvector.tutorial.isos/", wsdlLocation = "http://localhost:2060/Vector?wsdl")
    ...
    extends Service
{
    ...
    private static final QName VECTORSERVICE_QNAME = new QName("http://servector.cesvector.isyvector.tutorial.isos/", "VectorService");
    ...
    public IVector getVectorPort() {
        return super.getPort(new QName("http://servector.cesvector.isyvector.tutorial.isos/", "VectorPort"), IVector.class);
    }
    ...
    public IVector getVectorPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://servector.cesvector.isyvector.tutorial.isos/", "VectorPort"), IVector.class, features);
    }
