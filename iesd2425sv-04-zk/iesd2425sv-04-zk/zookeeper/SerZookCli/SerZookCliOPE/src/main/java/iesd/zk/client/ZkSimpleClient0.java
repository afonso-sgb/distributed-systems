...
public class ZkSimpleClient0 implements Watcher {

    protected final Logger LOG = Logger.getLogger(ZkSimpleClient0.class);

    final String ZOOKEEPER_SERVER = "localhost:2181";
    ...
    public ZkSimpleClient0() throws UnsupportedEncodingException {
